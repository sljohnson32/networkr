    ...
    return (
      <div>
        <aside className='all-contactzz'>
          ...
          <h3 className='contact-directory'>Contact Directory</h3>
        ...
        <section className='contact-info'>
          {onNewContactForm ? <NewContactForm
              contact={ {} }
          ...
          {selectedContact !== null ? <NewContactForm
              ...
              setSelectedContact={ setSelectedContact }
            /> : <div />}
          {selectedContact === null && !onNewContactForm ? <h3>Please select a contact from the list on the left to display more details</h3> : <div />}
        </section>
      </div>
    )
  }
