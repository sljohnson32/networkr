      ...
      return (
        <div>
          ...
          <ul className = 'nav-list'>
            ...
            <li className='nav-selected follow-up'  onClick={ () => displayFollowUpzz() }>Follow-ups</li>
            <li className='nav-selected contact' onClick={ () => displayContactzz() }>Contacts</li>
          </ul>
          </section>
        </div>
      )
      ...
      return (
        <div>
          ...
          <ul className = 'nav-list'>
            ...
            <li className='nav-selected contact'>Contacts</li>
          </ul>
          </section>
        </div>
      )
